...
function DesktopSidebar() {
  ...
  return (
    <aside className={cn(
      "hidden md:flex flex-col bg-[#134686] text-white h-screen max-h-screen sticky top-0 shrink-0 transition-all duration-200 overflow-x-hidden",
      collapsed ? "w-16" : "w-64"
    )}>
      {/* Logo */}
          ...
          collapsed ? (
            ...
            <>
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-red-500/10 px-3 py-2 text-sm font-bold text-red-300 transition hover:bg-red-500/20 hover:text-red-200"
              >
